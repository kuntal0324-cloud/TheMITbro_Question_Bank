#!/usr/bin/env python3
"""Build the XeLaTeX-rendered, fillable Batch 003 human final-QA packet."""
...
DEFAULT_OUTPUT = ROOT / "output/pdf/GATE_EE_BATCH003_HUMAN_FINAL_QA_MOBILE_FILLABLE.pdf"
REQUIRED_ATTESTATION = (
    "I independently reviewed the Batch 003 questions, answers and solutions "
...
header-includes:
  - |
    ...
    \pagestyle{fancy}
    \fancyhf{}
    \lhead{TheMITbro - Batch 003 Human Final QA}
    \rhead{Reviewer copy}
    \cfoot{\thepage}
...
def run() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="themitbro-human-qa-") as temp_dir:
        ...
        markdown_path = staging / "BATCH_003_HUMAN_FINAL_QA_MOBILE.md"
