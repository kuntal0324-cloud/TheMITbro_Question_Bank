...
**Release checkpoint:** blocked; RC1 has not received checksum-bound exact-artifact release authorization. Pricing, storefront activation and sale are separate later gates.
...
| Released papers | 0 | 50 | RC1 authorization pending |
...
6. **Current gate:** have a named reviewer complete and import the exact-artifact RC1 release-authorization form.
7. After authorization, promote an immutable release manifest, stage the authorized learner pack in the storefront, set an explicit price, and rerun payment/download controls. No sale or release is currently authorized.
